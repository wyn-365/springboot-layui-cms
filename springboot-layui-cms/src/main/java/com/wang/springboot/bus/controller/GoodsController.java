...
import com.wang.springboot.bus.service.GoodsService;
import com.wang.springboot.bus.service.ProviderService;
import com.wang.springboot.bus.vo.GoodsVo;
...
public class GoodsController {
    ...
    public ResultObj addGoods(GoodsVo goodsVo,HttpServletRequest request){

        try {
            if (goodsVo.getGoodsimg()!=null&&goodsVo.getGoodsimg().endsWith("_temp")){
                String newName = AppFileUtils.renameFile(goodsVo.getGoodsimg(),request);
